  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li>
          <a class="page-scroll dropdown-toggle" data-toggle="dropdown">Sign up<span class="caret"></span></a>
          <ul class="dropdown-menu bg-primary" style="padding: 20px 10px 5px 10px; width:300px;">
            <form>
              <fieldset id="inputs">
                <h4>Username</h4>
                <input style="color: #222" id="nama" type="nama" name="nama" placeholder="Nama Lengkap Anda" required>
                <h4>E-mail</h4>   
                <input style="color: #222" id="email" type="email" name="email" placeholder="pitik@gmail.com" required>
                <h4>Password</h4>   
                <input style="color: #222" id="password" type="password" name="Password" placeholder="********" required>
              </fieldset>
              <fieldset id="actions">
                <a id="signup" href="" class="btn btn-dark btn-round">sign up</a>
              </fieldset>
            </form>
          </ul>
        </li>
  ...
  <div class="row">
    <div class="col-md-9 col-lg-offset-1">
      ...
      <p style="text-align:left;">
        <a class="btn btn-primary" href="berita.php">Kembali
